...
export const zhCn: Dict = {
  ...
  wifiProfilesLoadError: '读取已保存的 Wi-Fi 网络失败。',
  wifiProfilesSaveError: '保存 Wi-Fi 网络失败。',
  wifiProfilesConnectError: '请求切换 Wi-Fi 失败。',
  wifiProfilesDuplicate: '每个 Wi-Fi 网络的 SSID 必须唯一。',
  wifiProfilesSaved: '已更新保存的 Wi-Fi 网络。',
  wifiProfilesEmpty: '尚未保存 Wi-Fi 网络。',
  wifiProfilesSave: '保存 Wi-Fi 网络',
  wifiProfilesHint: '仅在断线时按从上到下的顺序尝试；当前连接健康时不会自动漫游。',
  wifiProfilesConnectConfirm: '立即切换 Wi-Fi？设备换网时当前网页连接可能会中断。',
  wifiProfilesConnectAccepted: '已请求切换 Wi-Fi。网络切换后请重新连接设备。',
  wifiProfilePriority: '优先级',
  wifiProfileActive: '当前已连接',
  wifiProfileUp: '上移',
  wifiProfileDown: '下移',
  wifiProfileConnect: '立即连接',
  wifiProfileRemove: '删除',
  wifiProfileAdd: '添加网络',
  wifiProfilePasswordKeep: '留空则保留已保存密码',
  wifiProfileOpenNetwork: '清除已保存密码（开放网络）',
  ...
  tailscaleDescription: '管理远程连接设置，并查看当前连接路径。',
  tailscaleRefresh: '刷新',
  tailscaleSectionStatus: 'Tailscale 状态',
  tailscaleSectionSettings: 'Tailscale 设置',
  tailscaleConnection: '连接状态',
  tailscaleConnected: '已连接',
  tailscaleDisconnected: '未连接',
  tailscalePath: '连接路径',
  tailscaleVpnIp: 'Tailscale IP',
  tailscalePeers: '在线 / 总节点数',
  ...
  tailscaleAuthKeyPlaceholder: '输入新密钥以替换已保存的密钥',
  tailscaleAuthKeyConfigured: '已配置。留空保存会保留现有密钥。',
  tailscaleAuthKeyNotConfigured: '未配置。密钥只写入、不回显。',
  tailscaleHostname: '设备主机名',
  tailscaleHostnamePlaceholder: 'esp-claw',
  tailscaleLoginServer: '登录服务器',
  tailscaleLoginServerPlaceholder: '留空使用默认服务',
  ...
  tailscaleMaxPeersHint: '允许范围：1–64，默认 16。',
  tailscaleMaxPeersValidation: '最大节点数必须是 1 到 64 之间的整数。',
  tailscaleStatusUnavailable: 'Tailscale 状态当前不可用。',
  tailscaleOnline: '在线',
  tailscaleOffline: '离线',
  tailscaleExitDirect: '直连',
  tailscaleExitRelay: '中继',
  tailscaleExitDerp: 'DERP',
