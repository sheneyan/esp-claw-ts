export const en = {
  ...
  tailscaleDescription: 'Manage remote connectivity and inspect the current connection path.',
  tailscaleRefresh: 'Refresh',
  tailscaleSectionStatus: 'Tailscale Status',
  tailscaleSectionSettings: 'Tailscale Settings',
  tailscaleConnection: 'Connection',
  tailscaleConnected: 'Connected',
  tailscaleDisconnected: 'Disconnected',
  tailscalePath: 'Path',
  tailscaleVpnIp: 'Tailscale IP',
  tailscalePeers: 'Online / Total Peers',
  tailscaleSelectedExit: 'Selected Exit Node',
  ...
  tailscaleAuthKeyPlaceholder: 'Enter a new key to replace the stored key',
  tailscaleAuthKeyConfigured: 'Configured. Leave blank to keep the stored key.',
  tailscaleAuthKeyNotConfigured: 'Not configured. The key is write-only and is never displayed.',
  tailscaleHostname: 'Device Hostname',
  tailscaleHostnamePlaceholder: 'esp-claw',
  tailscaleLoginServer: 'Login Server',
  tailscaleLoginServerPlaceholder: 'Leave blank for the default service',
  tailscaleExitNode: 'Exit Node',
  tailscaleExitNodeHint:
  ...
  tailscaleMaxPeersHint: 'Allowed range: 1–64. Default: 16.',
  tailscaleMaxPeersValidation: 'Maximum peers must be a whole number from 1 to 64.',
  tailscaleStatusUnavailable: 'Tailscale status is currently unavailable.',
  tailscaleOnline: 'online',
  tailscaleOffline: 'offline',
  tailscaleExitDirect: 'direct',
  tailscaleExitRelay: 'relay',
